...
import female from "./images/gallery/female-doctor-with-presenting-hand-gesture.jpg";
import medium from "./images/gallery/medium-shot-man-getting-vaccine.jpg";
            ...
            <div className="col-lg-4 col-md-5 col-12 mx-auto">
              <div className="featured-circle bg-white shadow-lg d-flex justify-content-center align-items-center">
                <p className="featured-text">
                  <span className="featured-number">12</span> Years<br></br> of
                  Experiences
                </p>
              </div>
            </div>
